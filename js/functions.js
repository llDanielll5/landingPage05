$(function(){
    ...
    $('.barra-preco').mousemove(function(e){
        if(isDrag){
            ...
            preco_atual = (currentValue/100) * maxPrice;
    ...
    function formatarTotal(preco_arr){
        if(preco_arr[0] < 1000){
            ...
            return preco_arr[0][0]+preco_arr[0][1]+preco_arr[1][1]+'.'+preco_arr[0].substr(3,preco_arr[0].length)+
            ','+preco_arr[1];
        }
    }
    ...
    /*
        ...
        FUNÇÕES DE SLIDER PERSONALIZADO DA PAGINA DE VEICULO
            INDIVIDUAL
    */
    ...
    /*
    CLICAR COM O ATRIBUTO CRIADO GOTO
    */
    var directory = '/Front-End/Portfólio/LandingPage_05'
   ...
   /* SISTEMA DE NAVEGAÇÃO DA PARTE DE DEPOIMENTOS DO INDEX */
